...
public class DataLoader implements CommandLineRunner, Ordered {
        ...
        public void run(String... args) throws Exception {
                ...
                createService("Desarrollo de APIs",
                                "APIs REST con Spring Boot: contratos estables, dominio claro y despliegue en producción.",
                                "api-icon");
                createService("Arquitectura Frontend",
                                "Angular con rutas lazy y estado predecible, alineado al dominio de negocio.",
                                "web-icon");
                createService("Modernización Legacy",
                                "Salida gradual de monolitos Java EE: módulos acotados, regresión automatizada y releases sin parar el negocio.",
                                "migration-icon");
                createService("Reportería y Datos",
                                "JasperReports y PL/SQL para volúmenes altos y PDFs auditables en entornos críticos.",
                                "report-icon");
                ...
                projectService.createProject(Project.builder()
                                ...
                                .description("200+ reportes Oracle Reports → JasperReports; validación en paralelo y reglas extraídas desde PL/SQL.")
                ...
                projectService.createProject(Project.builder()
                                ...
                                .description("Integración core bancario ↔ app móvil: SOAP/REST, IBM Cloud y latencia controlada en operaciones críticas.")
                ...
                projectService.createProject(Project.builder()
                                ...
                                .description("Gateway Spring Cloud + Redis + Resilience4j para picos de tráfico sin saturar servicios internos.")
                ...
                projectService.createProject(Project.builder()
                                ...
                                .description("Portafolio full stack open source: Spring Boot, Angular, Docker y CI/CD. Código en GitHub.")
                ...
                Article a1 = Article.builder()
                                ...
                                .summary("Migrar monolitos Java EE sin reescribir todo: Strangler Fig, tests de caracterización y extracción de PL/SQL.")
                ...
                Article a2 = Article.builder()
                                ...
                                .summary("Signals en Angular 17: estado local más simple y cuándo seguir usando RxJS para HTTP y streams.")
                ...
                Article a3 = Article.builder()
                                ...
                                .summary("Multi-stage builds e imágenes distroless para recortar tamaño y tiempo de despliegue en CI.")
                ...
                Article a4 = Article.builder()
                                ...
                                .summary("Capas de servicio, compilación en arranque y tips para PDFs consistentes con JasperReports.")
                ...
                Article a5 = Article.builder()
                                ...
                                .summary("Paquetes core/usecase/adapters en Spring Boot con ejemplos de inversión de dependencias.")
                ...
                experienceService.createExperience(Experience.builder()
                                ...
                                .description("Full Stack (Spring Boot + Angular). APIs REST y modernización Jakarta EE → microservicios.")
                ...
                experienceService.createExperience(Experience.builder()
                                ...
                                .description("Integración core bancario con canal móvil (SOAP/REST, IBM Cloud, message brokers).")
                                .startDate(LocalDate.of(2024, 6, 1))
                ...
                experienceService.createExperience(Experience.builder()
                                ...
                                .description("Migración masiva de reporting Oracle→Jasper y mantenimiento del sistema financiero (Java/Jakarta EE).")
                ...
                experienceService.createExperience(Experience.builder()
                                ...
                                .description("Sistemas IT, automatización de procesos e infraestructura para operación diaria.")
